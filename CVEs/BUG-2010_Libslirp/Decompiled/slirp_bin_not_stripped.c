...
undefined8 in6_equal(void *param_1,void *param_2)
...
void in6_compute_ethaddr(undefined8 param_1,undefined8 param_2,undefined *param_3)
...
undefined8 get_dns_addr_cached(void *param_1,void *param_2,uint param_3,stat *param_4,int *param_5)

{
  ...
  if ((uint)(curtime - *param_5) < 1000) {
    memcpy(param_1,param_2,(ulong)param_3);
    uVar7 = 0;
  }
  else {
    _Var2 = param_4->st_dev;
    _Var3 = param_4->st_ino;
    lVar4 = param_4->st_size;
    lVar5 = (param_4->st_mtim).tv_sec;
    iVar6 = stat("/etc/resolv.conf",param_4);
    if (iVar6 == 0) {
      if ((((param_4->st_dev == _Var2) && (param_4->st_ino == _Var3)) && (param_4->st_size == lVar4)
          ) && ((param_4->st_mtim).tv_sec == lVar5)) {
        memcpy(param_1,param_2,(ulong)param_3);
        uVar7 = 0;
      }
      else {
...
get_dns_addr_resolv_conf
          (int param_1,void *param_2,void *param_3,uint param_4,uint *param_5,undefined4 *param_6)
...
ulong get_dns_addr(undefined8 param_1)

{
  ...
  if ((dns_addr != 0) &&
     (uVar1 = get_dns_addr_cached(param_1,&dns_addr,4,dns_addr_stat_14440,&dns_addr_time),
     (int)uVar1 < 1)) {
    return (ulong)uVar1;
  }
  uVar2 = get_dns_addr_resolv_conf(2,param_1,&dns_addr,4,0,&dns_addr_time);
  return uVar2;
}



ulong get_dns6_addr(undefined8 param_1,undefined8 param_2)

{
  ...
  local_28 = 0;
  local_20 = 0;
  cVar1 = in6_equal(dns6_addr,&local_28);
  if (cVar1 != '\x01') {
    uVar2 = get_dns_addr_cached(param_1,dns6_addr,0x10,dns6_addr_stat_14446,&dns6_addr_time);
    if ((int)uVar2 < 1) {
      uVar3 = (ulong)uVar2;
      goto LAB_00103303;
    }
  }
  uVar3 = get_dns_addr_resolv_conf(10,param_1,dns6_addr,0x10,param_2,&dns6_addr_time);
LAB_00103303:
  if (local_10 != *(long *)(in_FS_OFFSET + 0x28)) {
                    // WARNING: Subroutine does not return
    __stack_chk_fail();
...

{
  ...
  local_10 = *(long *)(in_FS_OFFSET + 0x28);
  if (initialized_14452 == 0) {
    initialized_14452 = 1;
    loopback_addr = htonl(0x7f000001);
    uVar1 = htonl(0xff000000);
    loopback_mask = (ulong)uVar1;
    ...
    if (lVar2 != 0) {
      ...
      local_20 = 8;
      slirp_debug = g_parse_debug_string(lVar2,&local_58,4);
    }
  }
  if (local_10 != *(long *)(in_FS_OFFSET + 0x28)) {
                    // WARNING: Subroutine does not return
        ...
        if ((*(long *)(param_1 + 0x16) == 0) ||
          ...
          *(undefined8 *)(lVar1 + 0x34) = uVar3;
          if (*(long *)(param_1 + 0x10) != 0) {
            slirp_pstrcpy(lVar1 + 0x58,0x21,*(undefined8 *)(param_1 + 0x10));
          }
          ...
          *(undefined8 *)(lVar1 + 0x1400) = uVar3;
          if (*(long *)(param_1 + 0x1e) != 0) {
            translate_dnssearch(lVar1,*(undefined8 *)(param_1 + 0x1e));
          }
...

{
  ...
  local_b0 = param_6;
  local_9c = param_9;
  slirp_new(&local_c8,param_22,param_23);
  if (local_10 != *(long *)(in_FS_OFFSET + 0x28)) {
                    // WARNING: Subroutine does not return
    __stack_chk_fail();
  }
...
void slirp_update_timeout(int *param_1,uint *param_2)
...
LAB_00103f9e:
  do {
    ...
    if (local_18 == param_1 + 0x14a) {
      slirp_update_timeout(param_1,param_2);
      return;
    }
    puVar1 = *(uint **)local_18;
    local_18[8] = 0xffffffff;
...

{
  ...
  curtime = (int)(lVar1 / 1000000);
  if ((*param_1 != 0) && (1 < (uint)(curtime - *param_1))) {
    tcp_fasttimo(param_1);
    *param_1 = 0;
  }
  if ((*(char *)(param_1 + 2) != '\0') && (0x1f2 < (uint)(curtime - param_1[1]))) {
    ip_slowtimo(param_1);
    tcp_slowtimo(param_1);
    param_1[1] = curtime;
  }
  if (param_2 == 0) {
        ...
        if ((local_2c & 4) == 0) {
          if ((local_2c & 0x19) != 0) {
            if ((local_20[0x53] & 0x100U) != 0) {
              tcp_connect(local_20);
              goto LAB_001042fc;
            }
            local_30 = soread(local_20);
            if (0 < local_30) {
              tcp_output(*(undefined8 *)(local_20 + 0x54));
            }
            goto joined_r0x001041b4;
          }
        }
        else {
          local_30 = sorecvoob(local_20);
joined_r0x001041b4:
          if (local_30 < 0) goto LAB_001042fc;
        }
        if (((local_20[0x53] & 1U) == 0) && ((local_2c & 10) != 0)) {
          if ((local_20[0x53] & 2U) == 0) {
            local_30 = sowrite(local_20);
            if (0 < local_30) {
              tcp_output(*(undefined8 *)(local_20 + 0x54));
            }
          }
            ...
            tcp_input(0,0x14,local_20,*(undefined2 *)(local_20 + 0x12));
          }
        }
      }
LAB_001042fc:
...
void arp_input(long param_1,long param_2)
  ...
  if (*(char *)(param_1 + 9) == '\x01') {
    ...
    if (uVar1 == 1) {
      if (*(int *)(param_2 + 0x26) == *(int *)(param_2 + 0x1c)) {
        arp_table_add(param_1,*(undefined4 *)(param_2 + 0x1c),param_2 + 0x16);
      }
...
LAB_0010459f:
          ...
          memcpy(local_52,&special_ethaddr,2);
          ...
          slirp_send_packet_all(param_1,local_58,0x40);
        }
        else {
...
void slirp_input(undefined8 param_1,void *param_2,int param_3)

{
  ...
  if (0xd < param_3) {
    ...
    if (uVar1 == 0x88f8) {
      ncsi_input(param_1,param_2,param_3);
    }
      ...
      if (uVar1 != 0x86dd) {
        ...
        if (uVar1 != 0x800) {
          ...
          arp_input(param_1,param_2,param_3);
          return;
        }
      }
      lVar2 = m_get(param_1);
...
undefined8 if_encap4(long param_1,long param_2,long param_3,undefined8 param_4)

{
  ...
  cVar1 = arp_table_search(param_1,*(undefined4 *)(lVar3 + 0x10),param_4);
  if (cVar1 == '\x01') {
    memcpy((void *)(param_3 + 6),&special_ethaddr,2);
    ...
    *(uint16_t *)(param_3 + 0xc) = uVar2;
    ...
    if (*(char *)(param_2 + 0x48) != '\x01') {
      ...
      memcpy(auStack_42,&special_ethaddr,2);
      ...
      local_35 = 4;
      local_34 = htons(1);
      memcpy(auStack_32,&special_ethaddr,2);
      ...
      *(undefined4 *)(param_1 + 0x54) = *(undefined4 *)(lVar3 + 0x10);
      slirp_send_packet_all(param_1,local_48,0x2a);
...
undefined8 if_encap6(long param_1,long param_2,long param_3,undefined8 param_4)

{
  ...
  lVar3 = *(long *)(param_2 + 0x30);
  cVar1 = ndp_table_search(param_1,*(undefined8 *)(lVar3 + 0x18),*(undefined8 *)(lVar3 + 0x20),
                           param_4);
  if (cVar1 == '\x01') {
    uVar2 = htons(0x86dd);
    *(uint16_t *)(param_3 + 0xc) = uVar2;
    in6_compute_ethaddr(*(undefined8 *)(lVar3 + 8),*(undefined8 *)(lVar3 + 0x10),param_3 + 6);
    uVar4 = 2;
  }
  else {
    if (*(char *)(param_2 + 0x48) != '\x01') {
      ndp_send_ns(param_1,*(undefined8 *)(lVar3 + 0x18),*(undefined8 *)(lVar3 + 0x20));
      *(undefined *)(param_2 + 0x48) = 1;
      lVar3 = (**(code **)(*(long *)(param_1 + 0x1768) + 0x10))(*(undefined8 *)(param_1 + 6000));
      *(long *)(param_2 + 0x50) = lVar3 + 1000000000;
    }
...
int if_encap(undefined8 param_1,long param_2)

{
  ...
  if (bVar2 == 4) {
    *(undefined8 *)(puVar4 + -0x1098) = 0x104d0f;
    iVar3 = if_encap4(param_1,param_2,&uStack_10068,&uStack_1006e);
joined_r0x00104d1c:
    ...
    if (bVar2 == 6) {
      *(undefined8 *)(puVar4 + -0x1098) = 0x104d4d;
      iVar3 = if_encap6(param_1,param_2,&uStack_10068,&uStack_1006e);
  ...
  *(undefined8 *)(puVar4 + -0x1098) = 0x104f2c;
  slirp_send_packet_all(param_1,&uStack_10068,(long)(iVar3 + 0xe));
  iVar3 = 1;
LAB_00104f31:
  if (local_10 != *(long *)(in_FS_OFFSET + 0x28)) {
                    // WARNING: Subroutine does not return
...
undefined8
slirp_add_hostfwd(long param_1,int param_2,undefined4 param_3,uint16_t param_4,int param_5,
                 uint16_t param_6)

{
  ...
  if (param_2 == 0) {
    uVar1 = htons(param_6);
    uVar2 = htons(param_4);
    lVar3 = tcp_listen(param_1,param_3,uVar2,local_30,uVar1,0x1000);
    if (lVar3 == 0) {
      return 0xffffffff;
    }
  }
    ...
    uVar1 = htons(param_6);
    uVar2 = htons(param_4);
    lVar3 = udp_listen(param_1,param_3,uVar2,local_30,uVar1,0x1000);
    if (lVar3 == 0) {
      return 0xffffffff;
    }
  }
...
undefined8 check_guestfwd(long param_1,uint *param_2,int param_3)
...
undefined8 slirp_add_exec(long param_1,undefined8 param_2,undefined4 *param_3,undefined4 param_4)

{
  ...
  cVar1 = check_guestfwd(param_1,param_3,param_4);
  if (cVar1 == '\x01') {
    uVar2 = htons((uint16_t)param_4);
    add_exec(param_1 + 0x80,param_2,*param_3,uVar2);
    uVar3 = 0;
  }
  else {
    uVar3 = 0xffffffff;
...
undefined8 slirp_add_unix(long param_1,undefined8 param_2,undefined4 *param_3,undefined4 param_4)

{
  ...
  if (cVar1 == '\x01') {
    uVar2 = htons((uint16_t)param_4);
    add_unix(param_1 + 0x80,param_2,*param_3,uVar2);
    uVar3 = 0;
  }
  else {
    uVar3 = 0xffffffff;
...
undefined8
slirp_add_guestfwd(long param_1,undefined8 param_2,undefined8 param_3,undefined4 *param_4,
                  undefined4 param_5)

{
  ...
  cVar1 = check_guestfwd(param_1,param_4,param_5);
  if (cVar1 == '\x01') {
    uVar2 = htons((uint16_t)param_5);
    add_guestfwd(param_1 + 0x80,param_2,param_3,*param_4,uVar2);
    uVar3 = 0;
  }
  else {
    uVar3 = 0xffffffff;
...
void slirp_remove_guestfwd(long param_1,undefined4 param_2,uint16_t param_3)

{
  uint16_t uVar1;
  
  uVar1 = htons(param_3);
  remove_guestfwd(param_1 + 0x80,param_2,uVar1);
  return;
}



size_t slirp_send(long param_1,void *param_2,size_t param_3,int param_4)
...
undefined8 * slirp_find_ctl_socket(long param_1,int param_2,uint param_3)
...
undefined8 slirp_socket_can_recv(undefined8 param_1,undefined4 param_2,undefined4 param_3)
...
void slirp_socket_recv(undefined8 param_1,undefined4 param_2,undefined4 param_3,undefined8 param_4,
                      undefined4 param_5)

{
  ...
  lVar2 = slirp_find_ctl_socket(param_1,param_2,param_3);
  if (lVar2 != 0) {
    iVar1 = soreadbuf(lVar2,param_4,param_5);
    if (0 < iVar1) {
      tcp_output(*(undefined8 *)(lVar2 + 0x150));
    }
  }
  return;
}
...
void slirp_send_packet_all(long param_1,undefined8 param_2,ulong param_3)

{
  ...
  else if ((uVar1 < param_3) && ((slirp_debug & 4) != 0)) {
...
int ncsi_calculate_checksum(long param_1,int param_2)
...
undefined8 ncsi_rsp_handler_gc(long param_1)
...
undefined8 ncsi_rsp_handler_gls(long param_1)
...
undefined8 ncsi_rsp_handler_gp(long param_1)
...
void ncsi_input(undefined8 param_1,long param_2)
...
LAB_0010598d:
      ...
      uVar1 = ncsi_calculate_checksum(&local_da,local_118);
      uVar1 = htonl(uVar1);
      *(uint32_t *)((long)&local_da + (long)local_118) = uVar1;
      slirp_send_packet_all(param_1,local_e8,(long)(local_118 + 0x12));
      if (local_10 != *(long *)(in_FS_OFFSET + 0x28)) {
                    // WARNING: Subroutine does not return
        __stack_chk_fail();
      }
    ...
    if ((uint)(byte)ncsi_rsp_handlers[(long)(int)local_11c * 0x10] ==
        *(byte *)(param_2 + 0x12) + 0x80) {
      local_110 = ncsi_rsp_handlers + (long)(int)local_11c * 0x10;
      goto LAB_0010598d;
    }
...

{
  ...
  do {
    ...
    uVar21 = (ulong)uVar14;
    bVar1 = tcp_outflags[(int)*(short *)(param_1 + 0x10)];
    if ((slirp_debug & 2) != 0) {
...
LAB_00106028:
    ...
    iVar20 = (int)uVar17;
    if (uVar17 == 0) {
      lVar19 = m_get(*(undefined8 *)(lVar3 + 0x28));
      if (lVar19 == 0) {
        local_ec = 1;
        goto LAB_001068fd;
      }
      ...
      *(long *)(lVar19 + 0x30) = *(long *)(lVar19 + 0x30) + 0x10;
      *(uint *)(lVar19 + 0x38) = uVar14;
      sbcopy(lVar3 + 0x188,(long)(int)uVar16,(long)iVar20,*(long *)(lVar19 + 0x30) + (ulong)uVar14);
    ...
    *(uint16_t *)((long)__dest + 0x3e) = uVar12;
    ...
    uVar13 = cksum(lVar19,uVar14 + iVar20);
    ...
    *(uint *)(lVar19 + 0x38) = uVar14 + iVar20;
    ...
    if (*(short *)(lVar3 + 0x48) == 2) {
      ...
      *(undefined *)(lVar4 + 1) = *(undefined *)(lVar3 + 0x148);
      local_ec = ip_output(lVar3,lVar19);
    }
      ...
      *(undefined *)(lVar4 + 6) = uStack_8f;
      local_ec = ip6_output(lVar3,lVar19,0);
    }
    else {
      g_assertion_message_expr
                ("Slirp",
...
void tcp_setpersist(long param_1)

{
  *(short *)(param_1 + 0x14) =
       (short)((int)*(short *)(param_1 + 0xbe) + (int)(*(short *)(param_1 + 0xbc) >> 2) >> 1) *
       (short)*(undefined4 *)(tcp_backoff + (long)(int)*(short *)(param_1 + 0x1a) * 4);
...
void slirp_socket_set_fast_reuse(int param_1)
...
void slirp_insque(long *param_1,long *param_2)
...
void slirp_remque(long *param_1)
...
undefined8 *
add_guestfwd(long *param_1,undefined8 param_2,undefined8 param_3,undefined4 param_4,
            undefined4 param_5)
...
long add_exec(undefined8 param_1,undefined8 param_2,undefined4 param_3,undefined4 param_4)

{
  long lVar1;
  undefined8 uVar2;
  
  lVar1 = add_guestfwd(param_1,0,0,param_3,param_4);
...
long add_unix(undefined8 param_1,undefined8 param_2,undefined4 param_3,undefined4 param_4)
...
undefined8 remove_guestfwd(long *param_1,int param_2,int param_3)
...
undefined8 slirp_socketpair_with_oob(int *param_1)
...
void fork_exec_child_setup(void)
...
void g_spawn_async_with_fds_slirp
...
undefined8 fork_exec(long param_1,undefined8 param_2)

{
  ...
  iVar1 = slirp_socketpair_with_oob(&local_18);
  if (iVar1 < 0) {
    uVar2 = 0;
  }
  else {
    ...
    if (iVar1 == 0) {
      ...
      g_spawn_async_with_fds_slirp
                (0,local_20,0,4,fork_exec_child_setup,0,0,local_14,local_14,local_14,&local_28);
      g_strfreev(local_20);
      if (local_28 == 0) {
        *(int *)(param_1 + 0x10) = local_18;
        close(local_14);
        slirp_socket_set_fast_reuse(*(undefined4 *)(param_1 + 0x10));
        local_2c = 1;
        setsockopt(*(int *)(param_1 + 0x10),1,10,&local_2c,4);
        slirp_set_nonblock(*(undefined4 *)(param_1 + 0x10));
...
undefined8 open_unix(long param_1,undefined8 param_2)
...

{
  ...
  for (local_d0 = *(undefined8 **)(param_1 + 0x1c0); local_d0 != (undefined8 *)(param_1 + 0x1c0);
    ...
    slirp_fmt0(local_48,0x14,"  TCP[%s]",local_c8);
  ...
  for (local_d0 = *(undefined8 **)(param_1 + 0x378); local_d0 != (undefined8 *)(param_1 + 0x378);
      local_d0 = (undefined8 *)*local_d0) {
    if ((*(uint *)((long)local_d0 + 0x14c) & 0x1000) == 0) {
      slirp_fmt0(local_48,0x14,"  UDP[%d sec]",(uint)(*(int *)(local_d0 + 0x2b) - curtime) / 1000);
      local_b8._4_4_ = *(in_addr_t *)((long)local_d0 + 0xcc);
      local_b8._2_2_ = *(uint16_t *)((long)local_d0 + 0xca);
      local_d8.s_addr = *(in_addr_t *)((long)local_d0 + 0x4c);
      local_da = *(uint16_t *)((long)local_d0 + 0x4a);
      ...
      slirp_fmt0(local_48,0x14,"  UDP[HOST_FORWARD]");
      local_d4 = 0x10;
      getsockname(*(int *)(local_d0 + 2),(sockaddr *)local_b8,&local_d4);
      local_d8.s_addr = *(in_addr_t *)((long)local_d0 + 0xcc);
      local_da = *(uint16_t *)((long)local_d0 + 0xca);
  ...
  for (local_d0 = *(undefined8 **)(param_1 + 0x528); local_d0 != (undefined8 *)(param_1 + 0x528);
      local_d0 = (undefined8 *)*local_d0) {
    slirp_fmt0(local_48,0x14,"  ICMP[%d sec]",(uint)(*(int *)(local_d0 + 0x2b) - curtime) / 1000);
    local_b8._4_4_ = *(in_addr_t *)((long)local_d0 + 0xcc);
...
int slirp_bind_outbound(long param_1,short param_2)
...
undefined8 ip6_output(undefined8 param_1,long param_2,int param_3)

{
  ...
  *pbVar1 = *pbVar1 & 0xf0;
  ...
  pbVar1[3] = 0;
  if (param_3 == 0) {
    if_output(param_1,param_2);
  }
  else {
    if_encap(*(undefined8 *)(param_2 + 0x40),param_2);
  }
  return 0;
}
...
void arp_table_add(long param_1,in_addr param_2,undefined *param_3)
...
undefined8 arp_table_search(long param_1,in_addr param_2,undefined *param_3)
...
void slirp_set_nonblock(int param_1)
...
void slirp_set_cloexec(int param_1)
...
int slirp_socket(int param_1,uint param_2,int param_3)
...
void slirp_pstrcpy(char *param_1,int param_2,char *param_3)
...
int slirp_vsnprintf(undefined8 param_1,undefined8 param_2,undefined8 param_3,undefined8 param_4)
...
ulong slirp_fmt(undefined8 param_1,undefined8 param_2,undefined8 param_3,undefined8 param_4,
...

{
  ...
  local_98 = param_13;
  local_90 = param_14;
  iVar1 = slirp_vsnprintf(param_9,param_10,param_11,&local_d8);
...
int slirp_fmt0(undefined8 param_1,undefined8 param_2,undefined8 param_3,undefined8 param_4,
              undefined8 param_5,undefined8 param_6,undefined8 param_7,undefined8 param_8,
...

{
  ...
  local_98 = param_13;
  local_90 = param_14;
  local_dc = slirp_vsnprintf(param_9,param_10,param_11,&local_d8);
...
undefined8 sbdrop(uint *param_1,ulong param_2)
...
void sbreserve(undefined4 *param_1,undefined8 param_2)
...
void sbappend(long param_1,long param_2)

{
  ...
  if (*(int *)(param_2 + 0x38) < 1) {
    ...
    if (*(int *)(param_1 + 0x168) == 0) {
      local_c = slirp_send(param_1,*(undefined8 *)(param_2 + 0x30),(long)*(int *)(param_2 + 0x38),0)
      ;
    }
    if (local_c < 1) {
      sbappendsb(param_1 + 0x168,param_2);
    }
...
void sbappendsb(int *param_1,long param_2)
...
void sbcopy(uint *param_1,long param_2,ulong param_3,void *param_4)
...
ulong domain_suffix_diffoff(long param_1,long param_2)
...
undefined8 domain_suffix_ord(long param_1,long param_2)

{
  ...
  lVar5 = domain_suffix_diffoff(param_1,param_2);
...
ulong domain_common_label(long param_1,undefined8 param_2)

{
  ...
  lVar1 = domain_suffix_diffoff(param_1,param_2);
...
void domain_fixup_order(long param_1,ulong param_2)
...
void domain_mklabels(long param_1,char *param_2)
...
void domain_mkxrefs(long param_1,long param_2,ulong param_3)

{
  ...
  for (; local_30 != param_2; local_30 = local_30 + 0x28) {
    if (param_3 != *(ulong *)(local_30 + 0x20)) {
      ...
      domain_mkxrefs(local_30,local_20,local_18);
      local_30 = local_20;
...
long domain_compactify(long *param_1,ulong param_2)
...
undefined8 translate_dnssearch(long param_1,long param_2)
  ...
  if (__nmemb == 0) {
    ...
    for (local_50 = 0; local_50 < __nmemb; local_50 = local_50 + 1) {
      *(long *)((long)__base + local_50 * 0x28 + 0x10) = local_40;
      domain_mklabels((void *)((long)__base + local_50 * 0x28),
                      *(undefined8 *)(param_2 + local_50 * 8));
    ...
    if (local_40 == lVar5) {
      ...
      qsort(__base,__nmemb,0x28,domain_suffix_ord);
      domain_fixup_order(__base,__nmemb);
      for (local_50 = 1; local_50 < __nmemb; local_50 = local_50 + 1) {
        uVar3 = domain_common_label((long)__base + local_50 * 0x28 + -0x28,
                                    (void *)(local_50 * 0x28 + (long)__base));
        *(undefined8 *)((long)__base + local_50 * 0x28 + -8) = uVar3;
      }
      domain_mkxrefs(__base,__nmemb * 0x28 + -0x28 + (long)__base,0);
      local_60 = domain_compactify(__base,__nmemb);
...

{
  ...
  while (local_18 != (undefined8 *)(param_1 + 0x378)) {
    ...
    udp_detach(*(undefined8 *)(param_1 + 0x378));
  }
  return;
}
...
void udp_input(long param_1,uint param_2)
...
LAB_001099ef:
    ...
    if (puVar1[3] != 0) {
      ...
      *(undefined2 *)((long)__s + 10) = puVar1[2];
      iVar9 = cksum(param_1,uVar8 + 0x14);
    ...
    if ((uVar7 == 0x43) &&
      ...
      if ((uVar7 == 0x45) && (*(int *)(__s + 2) == *(int *)(lVar3 + 0x14))) {
        ...
        *(uint *)(param_1 + 0x38) = *(int *)(param_1 + 0x38) - local_fc;
        tftp_input(&local_b8,param_1);
        *(long *)(param_1 + 0x30) = *(long *)(param_1 + 0x30) - (long)(int)local_fc;
        *(uint *)(param_1 + 0x38) = local_fc + *(int *)(param_1 + 0x38);
      }
      else if (*(int *)(lVar3 + 0x7c) == 0) {
        local_f0 = solookup(lVar3 + 0x520,lVar3 + 0x378,&local_b8,0);
        if (local_f0 == 0) {
          local_f0 = socreate(lVar3);
          iVar9 = udp_attach(local_f0,2);
          if (iVar9 == -1) {
            if ((slirp_debug & 2) != 0) {
        ...
        *(long *)(param_1 + 0x30) = (long)iVar9 + *(long *)(param_1 + 0x30);
        iVar10 = sosendto(local_f0,param_1);
        if (iVar10 != -1) {
          m_free(*(undefined8 *)(local_f0 + 0x30));
        ...
        *(undefined4 *)(__s + 2) = uVar2;
        ...
        piVar11 = __errno_location();
        pcVar12 = strerror(*piVar11);
        icmp_send_error(param_1,3,0,0,pcVar12);
      }
    }
  }
  else if (uVar8 <= *(ushort *)((long)__s + 2)) {
    m_adj(param_1,uVar8 - *(ushort *)((long)__s + 2));
...
undefined4 udp_output(undefined8 param_1,long param_2,long param_3,long param_4,undefined param_5)

{
  ...
  *(undefined2 *)((long)__s + 0x1a) = 0;
  uVar2 = cksum(param_2,*(undefined4 *)(param_2 + 0x38));
  ...
  *(undefined *)((long)__s + 1) = param_5;
  uVar3 = ip_output(param_1,param_2);
  return uVar3;
}



undefined4 udp_attach(long param_1,undefined2 param_2)

{
  undefined4 uVar1;
  int iVar2;
  
  uVar1 = slirp_socket(param_2,2,0);
  *(undefined4 *)(param_1 + 0x10) = uVar1;
  if (*(int *)(param_1 + 0x10) != -1) {
    iVar2 = slirp_bind_outbound(param_1,param_2);
    if (iVar2 != 0) {
      close(*(int *)(param_1 + 0x10));
      *(undefined4 *)(param_1 + 0x10) = 0xffffffff;
      return 0xffffffff;
    }
    *(int *)(param_1 + 0x158) = curtime + 240000;
    slirp_insque(param_1,*(long *)(param_1 + 0x28) + 0x378);
  }
...
undefined udp_tos(long param_1)

{
  ...
  local_c = 0;
  while( true ) {
    if (udptos[(long)local_c * 6 + 4] == '\0') {
      return 0;
    }
    if (((*(short *)(udptos + (long)local_c * 6 + 2) != 0) &&
        (uVar1 = ntohs(*(uint16_t *)(param_1 + 0x4a)),
        uVar1 == *(uint16_t *)(udptos + (long)local_c * 6 + 2))) ||
       ((*(short *)(udptos + (long)local_c * 6) != 0 &&
        (uVar1 = ntohs(*(uint16_t *)(param_1 + 0xca)),
        uVar1 == *(uint16_t *)(udptos + (long)local_c * 6))))) break;
    local_c = local_c + 1;
  }
  if (*(char *)(*(long *)(param_1 + 0x28) + 0x1760) != '\0') {
    *(undefined1 *)(param_1 + 0x149) = udptos[(long)local_c * 6 + 5];
  }
  return udptos[(long)local_c * 6 + 4];
}



long udp_listen(long param_1,undefined4 param_2,undefined2 param_3,undefined4 param_4,
...

{
  ...
  local_30 = socreate(param_1);
  uVar1 = slirp_socket(2,2,0);
  *(undefined4 *)(local_30 + 0x10) = uVar1;
  if (*(int *)(local_30 + 0x10) < 0) {
    ...
    *(int *)(local_30 + 0x158) = curtime + 240000;
    slirp_insque(local_30,param_1 + 0x378);
    ...
    if (iVar2 < 0) {
      ...
      slirp_socket_set_fast_reuse(*(undefined4 *)(local_30 + 0x10));
...
byte tcp_reass(undefined8 *param_1,undefined8 *param_2,undefined8 param_3)
...
void tcp_input(long param_1,uint param_2,long param_3,short param_4)

{
  ...
  if (param_1 == 0) {
    ...
    *(undefined8 *)(param_3 + 0x30) = 0;
    ...
    if ((*(uint *)(param_3 + 0x14c) & 1) != 0) {
      plVar19 = (long *)tcp_close(plVar19);
      goto LAB_0010c9e1;
    }
    goto LAB_0010bb05;
  }
  ...
  iVar14 = cksum(param_1,local_21c + 0x30);
  if (iVar14 != 0) {
LAB_0010caa5:
    m_free(param_1);
    goto LAB_0010caba;
  ...
  *(uint *)(param_1 + 0x38) = *(int *)(param_1 + 0x38) + (uint)bVar10 * -4 + -0x30;
  while( true ) {
    ...
    local_1e0 = solookup(local_1d0 + 0x368,local_1d0 + 0x1c0,&local_148,&local_c8);
    local_230 = param_1;
    if (local_1e0 == 0) {
      ...
      local_1e0 = socreate(local_1d0);
      tcp_attach(local_1e0);
      sbreserve(local_1e0 + 0x188,0x20000);
      sbreserve(local_1e0 + 0x168,0x20000);
    ...
    *(undefined2 *)((long)plVar19 + 0xb4) = 0;
    ...
    if ((local_1e8 != 0) && (*(short *)(plVar19 + 2) != 1)) {
      tcp_dooptions(plVar19,local_1e8,local_220,unaff_R12);
    }
      ...
      if (*(short *)((long)unaff_R12 + 0x2e) == 0) {
        if (((0 < *(int *)((long)unaff_R12 + 0x38) - *(int *)(plVar19 + 0xf)) &&
          ...
          if ((*(short *)((long)plVar19 + 0xb6) != 0) &&
            ...
            tcp_xmit_timer(plVar19,(int)*(short *)((long)plVar19 + 0xb6));
          }
          sodrop(local_1e0,*(int *)((long)unaff_R12 + 0x38) - *(int *)(plVar19 + 0xf));
        ...
        *(uint *)(plVar19 + 0x13) =
        ...
        if (*(char *)(local_1e0 + 0x149) == '\0') {
          sbappend(local_1e0,param_1);
        }
        else {
          iVar14 = tcp_emu(local_1e0,param_1);
          if (iVar14 != 0) {
            sbappend(local_1e0,param_1);
          }
        }
      ...
      *(ushort *)((long)plVar19 + 0x24) = *(ushort *)((long)plVar19 + 0x24) | 1;
      if (((bVar20 & 0x10) == 0) || (*(int *)(plVar19 + 0xf) - *(int *)((long)plVar19 + 0x8c) < 1))
      {
        *(undefined2 *)(plVar19 + 2) = 3;
        ...
        soisfconnected(local_1e0);
        *(undefined2 *)(plVar19 + 2) = 4;
        tcp_reass(plVar19,0,0);
        if (*(short *)((long)plVar19 + 0xb6) != 0) {
          tcp_xmit_timer(plVar19,(int)*(short *)((long)plVar19 + 0xb6));
        }
      }
...
LAB_0010c01b:
  ...
  if ((bVar20 & 2) != 0) {
    plVar19 = (long *)tcp_drop(plVar19,0);
LAB_0010c9e1:
    if ((bVar20 & 0x10) == 0) {
      if ((bVar20 & 2) != 0) {
        *(short *)((long)unaff_R12 + 0x2e) = *(short *)((long)unaff_R12 + 0x2e) + 1;
      }
      tcp_respond(plVar19,unaff_R12,local_230,
                  *(int *)((long)unaff_R12 + 0x34) + (uint)*(ushort *)((long)unaff_R12 + 0x2e),0,
                  0x14,param_4);
    }
    else {
      tcp_respond(plVar19,unaff_R12,local_230,0,*(undefined4 *)((long)unaff_R12 + 0x38),4,param_4);
    }
    goto LAB_0010caba;
  }
        ...
        *(short *)((long)plVar19 + 0x1e) = *(short *)((long)plVar19 + 0x1e) + 1;
        if (*(short *)((long)plVar19 + 0x1e) == 3) {
          ...
          *(uint *)((long)plVar19 + 0xac) = (uint)*(ushort *)(plVar19 + 4);
          tcp_output(plVar19,(ulong)uVar1,(ulong)(uVar17 >> 1) % (ulong)uVar1);
...
LAB_0010c5c4:
  ...
  if (((*(short *)((long)unaff_R12 + 0x2e) == 0) && ((bVar20 & 1) == 0)) ||
    ...
    *(uint *)(plVar19 + 0x13) = (uint)*(ushort *)((long)unaff_R12 + 0x2e) + *(int *)(plVar19 + 0x13)
    ...
    if (*(char *)(local_1e0 + 0x149) == '\0') {
      sbappend(local_1e0,local_230);
    }
    else {
      iVar14 = tcp_emu(local_1e0,local_230);
      if (iVar14 != 0) {
        sbappend(local_1e0,local_230);
      }
    }
    ...
    bVar10 = tcp_reass(plVar19,unaff_R12,local_230);
    *(ushort *)((long)plVar19 + 0x24) = *(ushort *)((long)plVar19 + 0x24) | 1;
  }
  if ((bVar10 & 1) != 0) {
...
LAB_0010b6df:
    if ((*(byte *)(local_1e0 + 0x149) & 0x10) == 0) {
      iVar14 = tcp_fconnect(local_1e0,*(undefined2 *)(local_1e0 + 0x48));
      if ((((iVar14 == -1) && (piVar15 = __errno_location(), *piVar15 != 0xb)) &&
        ...
        piVar15 = __errno_location();
        if (*piVar15 == 0x6f) {
          tcp_respond(plVar19,unaff_R12,param_1,*(int *)((long)unaff_R12 + 0x34) + 1,0,0x14,param_4)
          ;
        }
        else {
          if (param_4 == 2) {
          ...
          *(uint *)(param_1 + 0x38) = uVar17 + *(int *)(param_1 + 0x38) + 0x30;
          if (param_4 == 2) {
            ...
            *(undefined4 *)(puVar4 + 2) = local_188;
            piVar15 = __errno_location();
            pcVar16 = strerror(*piVar15);
            icmp_send_error(param_1,3,local_221,0,pcVar16);
          }
          else if (param_4 == 10) {
            *(long *)(param_1 + 0x30) = *(long *)(param_1 + 0x30) + 8;
            *(int *)(param_1 + 0x38) = *(int *)(param_1 + 0x38) + -8;
            *puVar5 = local_178;
            ...
            puVar5[3] = local_160;
            puVar5[4] = local_158;
            icmp6_send_error(param_1,1,local_221);
          }
          else {
            g_assertion_message_expr
                      ("Slirp",
...
LAB_0010bd1a:
  *(int *)((long)unaff_R12 + 0x34) = *(int *)((long)unaff_R12 + 0x34) + 1;
  if (*(uint *)((long)plVar19 + 0x94) < (uint)*(ushort *)((long)unaff_R12 + 0x2e)) {
    m_adj(local_230,-((uint)*(ushort *)((long)unaff_R12 + 0x2e) - *(int *)((long)plVar19 + 0x94)));
...
void tcp_dooptions(undefined8 param_1,char *param_2,int param_3,long param_4)
...
void tcp_xmit_timer(long param_1,int param_2)
...
uint tcp_mss(long param_1,uint param_2)
...
void ifs_insque(long param_1,long param_2)
...
void if_output(long param_1,long param_2)
    ...
    for (local_18 = *(long *)(lVar1 + 0xd8); local_18 != lVar1 + 0xd0;
      ...
      if (param_1 == *(long *)(local_18 + 0x28)) {
        *(long *)(param_2 + 0x28) = param_1;
        ifs_insque(param_2,*(undefined8 *)(local_18 + 0x18));
        goto LAB_0010d347;
      }
    }
  }
  ...
  if (param_1 != 0) {
    ...
    *(int *)(param_1 + 0x160) = *(int *)(param_1 + 0x160) + 1;
    if (((true) && (5 < *(int *)(param_1 + 0x160))) &&
      ...
      slirp_remque(*(undefined8 *)(param_2 + 0x10));
      slirp_insque(*(undefined8 *)(param_2 + 0x10),lVar1 + 0xd0);
    }
  }
  if_start(*(undefined8 *)(param_2 + 0x40));
  return;
}



void if_start(long param_1)
  ...
  if (*(char *)(param_1 + 0xe0) == '\0') {
    *(undefined *)(param_1 + 0xe0) = 1;
    ...
    while (plVar4 = local_38, local_38 != (long *)0x0) {
      ...
      if (((ulong)plVar4[10] < uVar6) || (iVar5 = if_encap(param_1,plVar4), iVar5 != 0)) {
        lVar1 = plVar4[1];
        slirp_remque(plVar4);
        if (plVar4 != (long *)plVar4[2]) {
          plVar2 = (long *)plVar4[2];
          slirp_insque(plVar2,lVar1);
          ifs_remque(plVar4);
          if (!bVar3) {
            local_38 = plVar2;
          }
...
uint cksum(long param_1,int param_2)
...
undefined4 ip6_cksum(long param_1)

{
  ...
  *(undefined *)((long)puVar3 + 0x27) = uStack_42;
  ...
  uVar11 = cksum(param_1,uVar10 + 0x28);
  *puVar2 = uVar4;
  puVar2[1] = uVar5;
  puVar2[2] = uVar6;
  puVar2[3] = uVar7;
...
void slirp_socket_set_nodelay(int param_1)
...
undefined8 sockaddr_size(short *param_1)
...
void tcp_cleanup(long param_1)

{
  while (*(long *)(param_1 + 0x1c0) != param_1 + 0x1c0) {
    tcp_close(*(undefined8 *)(*(long *)(param_1 + 0x1c0) + 0x150));
  }
  return;
}
...
void tcp_template(long param_1)
...
void tcp_respond(long param_1,undefined8 *param_2,long param_3,uint32_t param_4,uint32_t param_5,
...

{
  ...
  if (param_3 == 0) {
    ...
    local_a0 = m_get(*(undefined8 *)(*(long *)(param_1 + 0x70) + 0x28));
...
undefined8 * tcp_newtcpcb(long param_1)
...
undefined8 tcp_close(undefined8 *param_1)
...
void tcp_sockclosed(long param_1)
...
int tcp_fconnect(long param_1,undefined2 param_2)

{
  ...
  uVar1 = slirp_socket(param_2,1,0);
  *(undefined4 *)(param_1 + 0x10) = uVar1;
  local_b0 = *(int *)(param_1 + 0x10);
  if ((local_b0 < 0) || (local_b0 = slirp_bind_outbound(param_1,param_2), -1 < local_b0)) {
    iVar2 = local_b0;
    if (-1 < local_b0) {
      local_ac = *(int *)(param_1 + 0x10);
      slirp_set_nonblock(local_ac);
      (**(code **)(*(long *)(*(long *)(param_1 + 0x28) + 0x1768) + 0x30))
                (*(undefined4 *)(param_1 + 0x10),*(undefined8 *)(*(long *)(param_1 + 0x28) + 6000));
      slirp_socket_set_fast_reuse(local_ac);
      local_b4 = 1;
      ...
      iVar2 = sotranslate_out(param_1,&local_a8);
      if (iVar2 < 0) {
        iVar2 = -1;
      }
      else {
        __len = sockaddr_size(&local_a8);
        local_b0 = connect(local_ac,&local_a8,__len);
        soisfconnecting(param_1);
        iVar2 = local_b0;
      }
    }
  }
...
void tcp_attach(long param_1)

{
  undefined8 uVar1;
  
  uVar1 = tcp_newtcpcb(param_1);
  *(undefined8 *)(param_1 + 0x150) = uVar1;
  slirp_insque(param_1,*(long *)(param_1 + 0x28) + 0x1c0);
  return;
}



undefined tcp_tos(long param_1)

{
  ...
  local_c = 0;
  while( true ) {
    if (tcptos[(long)local_c * 6 + 4] == '\0') {
      return 0;
    }
    if (((*(short *)(tcptos + (long)local_c * 6 + 2) != 0) &&
        (uVar1 = ntohs(*(uint16_t *)(param_1 + 0x4a)),
        uVar1 == *(uint16_t *)(tcptos + (long)local_c * 6 + 2))) ||
       ((*(short *)(tcptos + (long)local_c * 6) != 0 &&
        (uVar1 = ntohs(*(uint16_t *)(param_1 + 0xca)),
        uVar1 == *(uint16_t *)(tcptos + (long)local_c * 6))))) break;
    local_c = local_c + 1;
  }
  if (*(char *)(*(long *)(param_1 + 0x28) + 0x1760) != '\0') {
    *(undefined1 *)(param_1 + 0x149) = tcptos[(long)local_c * 6 + 5];
  }
  return tcptos[(long)local_c * 6 + 4];
}



undefined8 tcp_emu(long param_1,long param_2)
...
switchD_0010f515_caseD_0:
    *(undefined *)(param_1 + 0x149) = 0;
    ...
    case 2:
      m_inc(param_2,*(int *)(param_2 + 0x38) + 1);
      *(undefined *)((long)*(int *)(param_2 + 0x38) + *(long *)(param_2 + 0x30)) = 0;
      ...
      if (local_158 == (byte *)0x0) {
                                        ...
                                        &local_174,&local_170,&local_16c,local_128), 5 < local_15c))
        {
          ...
          lVar9 = tcp_listen(local_148,0,0,local_168,local_164,0x200);
          if (lVar9 != 0) {
            ...
            *(int *)(param_2 + 0x38) = (int)local_158 - (int)*(undefined8 *)(param_2 + 0x30);
            ...
            iVar5 = slirp_fmt(local_158,lVar9 - *(int *)(param_2 + 0x38),
        ...
        if (5 < local_15c) {
          ...
          if (lVar9 != 0) {
            ...
            *(int *)(param_2 + 0x38) = (int)local_158 - (int)*(undefined8 *)(param_2 + 0x30);
            ...
            iVar5 = slirp_fmt(local_158,lVar9 - *(int *)(param_2 + 0x38),
                              "ORT %d,%d,%d,%d,%d,%d\r\n%s",local_180,local_17c,local_178,local_174,
                              local_170,local_16c,pbVar8);
            *(int *)(param_2 + 0x38) = *(int *)(param_2 + 0x38) + iVar5;
          }
        }
      }
    ...
    case 3:
      *(undefined *)(param_1 + 0x149) = 0;
      ...
      if ((*(char *)((long)*(int *)(param_2 + 0x38) + -1 + *(long *)(param_2 + 0x30)) == '\0') &&
        ...
        lVar9 = tcp_listen(local_148,0,0,*(undefined4 *)(param_1 + 0xcc),uVar3,0x200);
        if (lVar9 != 0) {
          uVar3 = ntohs(*(uint16_t *)(lVar9 + 0x4a));
          if ((*(uint *)(param_2 + 0x20) & 1) == 0) {
            lVar9 = (param_2 + 0x60 + (long)*(int *)(param_2 + 0x24)) - *(long *)(param_2 + 0x30);
          ...
          uVar6 = slirp_fmt0(*(undefined8 *)(param_2 + 0x30),lVar9,&DAT_0011de41,uVar3);
      ...
      *(undefined *)((long)*(int *)(param_2 + 0x38) + *(long *)(param_2 + 0x30)) = 0;
      ...
      if (local_158 != (byte *)0x0) {
        ...
        if (iVar5 == 3) {
          ...
          lVar9 = tcp_listen(local_148,0,0,uVar7,uVar3,0x200);
          if (lVar9 != 0) {
            *(int *)(param_2 + 0x38) = (int)local_158 - (int)*(undefined8 *)(param_2 + 0x30);
            uVar3 = ntohs(*(uint16_t *)(lVar9 + 0x4a));
            ...
            iVar5 = slirp_fmt(local_158,lVar9 - *(int *)(param_2 + 0x38),"DCC CHAT chat %lu %u%c\n",
                              uVar7,uVar3,1);
            *(int *)(param_2 + 0x38) = *(int *)(param_2 + 0x38) + iVar5;
          }
        }
      ...
      if (local_158 < (byte *)((long)*(int *)(param_2 + 0x38) + *(long *)(param_2 + 0x30))) {
        ...
        case 1:
          if (*local_158 == 0x50) {
            ...
            bVar1 = *local_158;
            local_158 = pbVar8;
            if (bVar1 == local_128[ra_14470]) break;
            ra_14470 = 0;
          }
          goto LAB_00110927;
        case 4:
      ...
      if (local_140 != (undefined *)0x0) {
        *local_140 = 0;
        ...
        if (iVar5 == 2) {
          ...
          uVar6 = slirp_fmt(*(undefined8 *)(param_2 + 0x30),lVar9,"%d,%d\r\n",local_180,local_17c);
          *(undefined4 *)(param_2 + 0x38) = uVar6;
        }
        else {
          *local_140 = 0xd;
...
LAB_001108a0:
  ...
  lVar9 = udp_listen(local_148,0,uVar4,uVar6,uVar3,0x200);
...
undefined8 tcp_ctl(long param_1)
  ...
  if (*(int *)(param_1 + 0x4c) != *(int *)(lVar1 + 0x14)) {
    for (local_20 = *(long **)(lVar1 + 0x80); local_20 != (long *)0x0;
      ...
      if ((*(uint *)((long)local_20 + 0x14) == (uint)*(ushort *)(param_1 + 0x4a)) &&
        ...
        if (local_20[4] != 0) {
          uVar3 = open_unix(param_1,local_20[4]);
          return uVar3;
        }
        uVar3 = fork_exec(param_1,local_20[3]);
        return uVar3;
      }
    }
  }
  uVar2 = slirp_fmt(*(undefined8 *)(param_1 + 400),
...

{
  ...
  slirp_insque(lVar1,param_1 + 0xa8);
  ...
  if (param_1 != 0) {
    ...
    if ((*(uint *)(param_1 + 0x20) & 8) == 0) {
      if ((*(uint *)(param_1 + 0x20) & 2) == 0) {
        slirp_insque(param_1,*(long *)(param_1 + 0x40) + 0x98);
...
void m_cat(long param_1,long param_2)

{
  ...
  if (lVar1 - *(int *)(param_1 + 0x38) < (long)*(int *)(param_2 + 0x38)) {
    m_inc(param_1,*(int *)(param_1 + 0x38) + *(int *)(param_2 + 0x38));
  }
...
void m_inc(long param_1,int param_2)
...
void m_adj(long param_1,int param_2)
...
undefined8 m_copy(long param_1,long param_2,int param_3,int param_4)
...
undefined8 * dtom(long param_1,undefined8 *param_2)
...
undefined4 in6_equal_net(void *param_1,void *param_2,uint param_3)
...
bool in6_equal_mach(long param_1,long param_2,uint param_3)
...
void ra_timer_handler(long param_1)
...

{
  ...
  if (*(char *)(param_1 + 10) == '\x01') {
    uVar3 = (**(code **)(*(long *)(param_1 + 0x1768) + 0x18))
                      (ra_timer_handler,param_1,*(undefined8 *)(param_1 + 6000));
...
void icmp6_cleanup(long param_1)
...
void icmp6_send_echoreply(long param_1,undefined8 param_2,long param_3)

{
  ...
  *(long *)(lVar6 + 0x30) = *(long *)(lVar6 + 0x30) + -0x28;
  uVar5 = ip6_cksum(lVar6);
  *(undefined2 *)(puVar3 + 2) = uVar5;
  ip6_output(0,lVar6,0);
  return;
}



void icmp6_send_error(long param_1,byte param_2,byte param_3)

{
  ...
  local_58 = 0;
  local_50 = 0;
  cVar7 = in6_equal(lVar3 + 8,&local_58);
...
LAB_00111c24:
  ...
  *(long *)(lVar12 + 0x30) = *(long *)(lVar12 + 0x30) + -8;
  *(long *)(lVar12 + 0x30) = *(long *)(lVar12 + 0x30) + -0x28;
  uVar9 = ip6_cksum(lVar12);
  *(undefined2 *)(pbVar6 + 2) = uVar9;
  ip6_output(0,lVar12,0);
LAB_00111cb0:
  if (local_10 == *(long *)(in_FS_OFFSET + 0x28)) {
    return;
  }
...

{
  ...
  *local_40 = 1;
  local_40[1] = 1;
  in6_compute_ethaddr(*(undefined8 *)(local_50 + 8),*(undefined8 *)(local_50 + 0x10),local_40 + 2);
  ...
  *(long *)(local_58 + 0x30) = *(long *)(local_58 + 0x30) + 0x20;
  ...
  iVar5 = get_dns6_addr(local_28,local_64);
  if (-1 < iVar5) {
  ...
  *(int *)(local_58 + 0x38) = (int)local_60 + 0x28;
  uVar3 = ip6_cksum(local_58);
  *(undefined2 *)(local_48 + 2) = uVar3;
  ip6_output(0,local_58,0);
  if (local_10 != *(long *)(in_FS_OFFSET + 0x28)) {
                    // WARNING: Subroutine does not return
    __stack_chk_fail();
  }
...
void ndp_send_ns(long param_1,undefined8 param_2,undefined8 param_3)

{
  ...
  *local_50 = 1;
  local_50[1] = 1;
  in6_compute_ethaddr(*(undefined8 *)(local_70 + 0x2c),*(undefined8 *)(local_70 + 0x34),local_50 + 2
                     );
  *(long *)(local_68 + 0x30) = *(long *)(local_68 + 0x30) + -0x18;
  *(long *)(local_68 + 0x30) = *(long *)(local_68 + 0x30) + -0x28;
  uVar3 = ip6_cksum(local_68);
  *(undefined2 *)(local_58 + 2) = uVar3;
  ip6_output(0,local_68,1);
  if (local_10 != *(long *)(in_FS_OFFSET + 0x28)) {
                    // WARNING: Subroutine does not return
    __stack_chk_fail();
  }
...
void ndp_send_na(undefined8 param_1,long param_2,long param_3)

{
  ...
  *(undefined8 *)(lVar1 + 0x10) = uVar2;
  local_28 = 0;
  local_20 = 0;
  cVar5 = in6_equal(param_2 + 8,&local_28);
  if (cVar5 == '\0') {
  ...
  *puVar4 = 2;
  puVar4[1] = 1;
  in6_compute_ethaddr(*(undefined8 *)(puVar3 + 8),*(undefined8 *)(puVar3 + 0x10),puVar4 + 2);
  *(long *)(lVar8 + 0x30) = *(long *)(lVar8 + 0x30) + -0x18;
  *(long *)(lVar8 + 0x30) = *(long *)(lVar8 + 0x30) + -0x28;
  uVar7 = ip6_cksum(lVar8);
  *(undefined2 *)(puVar3 + 2) = uVar7;
  ip6_output(0,lVar8,0);
  if (local_10 != *(long *)(in_FS_OFFSET + 0x28)) {
                    // WARNING: Subroutine does not return
    __stack_chk_fail();
  }
...
void ndp_input(long param_1,long param_2,long param_3,undefined *param_4)
  ...
  *(long *)(param_1 + 0x30) = *(long *)(param_1 + 0x30) + 0xe;
  ...
  case 0x85:
    ...
    if (((*(char *)(param_3 + 7) == -1) && (param_4[1] == '\0')) &&
      ...
      ndp_table_add(param_2,*(undefined8 *)(param_3 + 8),*(undefined8 *)(param_3 + 0x10),lVar1 + 6);
      ndp_send_ra(param_2);
    }
    break;
  case 0x86:
  ...
  case 0x87:
    ...
    if (((*(char *)(param_3 + 7) == -1) && (param_4[1] == '\0')) &&
      ...
      local_58 = 0;
      local_50 = 0;
      cVar2 = in6_equal(param_3 + 8,&local_58);
      if (cVar2 == '\x01') {
        local_48 = 0xff;
        local_47 = 2;
        local_46 = 0;
        ...
        local_3a = 0;
        local_39 = 0;
        cVar2 = in6_equal_net(param_3 + 0x18,&local_48,0x68);
        if (cVar2 == '\0') break;
      }
      cVar2 = in6_equal_net(param_4 + 8,param_2 + 0x18,*(undefined *)(param_2 + 0x28));
      if ((cVar2 == '\0') ||
         (cVar2 = in6_equal_mach(param_4 + 8,param_2 + 0x2c,*(undefined *)(param_2 + 0x28)),
         cVar2 == '\0')) {
        local_38 = 0x80fe;
        local_30 = 0x200000000000000;
        cVar2 = in6_equal_net(param_4 + 8,&local_38,0x40);
        if (((cVar2 == '\0') ||
            (cVar2 = in6_equal_mach(param_4 + 8,param_2 + 0x2c,0x40), cVar2 == '\0')) &&
           ((cVar2 = in6_equal_net(param_4 + 8,param_2 + 0x18,*(undefined *)(param_2 + 0x28)),
            cVar2 == '\0' ||
            (cVar2 = in6_equal_mach(param_4 + 8,param_2 + 0x44,*(undefined *)(param_2 + 0x28)),
            cVar2 == '\0')))) {
          local_28 = 0x80fe;
          local_20 = 0x200000000000000;
          cVar2 = in6_equal_net(param_4 + 8,&local_28,0x40);
          if ((cVar2 == '\0') ||
             (cVar2 = in6_equal_mach(param_4 + 8,param_2 + 0x44,0x40), cVar2 == '\0')) break;
        }
      }
      ndp_table_add(param_2,*(undefined8 *)(param_3 + 8),*(undefined8 *)(param_3 + 0x10),lVar1 + 6);
      ndp_send_na(param_2,param_3,param_4);
    }
    break;
  case 0x88:
    if ((slirp_debug & 1) != 0) {
...

{
  ...
  if ((3 < uVar6) && (iVar7 = ip6_cksum(param_1), iVar7 == 0)) {
    ...
    *(long *)(param_1 + 0x30) = *(long *)(param_1 + 0x30) + -0x28;
    ...
    bVar1 = *pbVar4;
    if (bVar1 == 0x80) {
      cVar5 = in6_equal_net(lVar2 + 0x18,lVar3 + 0x18,*(undefined *)(lVar3 + 0x28));
      if ((cVar5 == '\0') ||
         (cVar5 = in6_equal_mach(lVar2 + 0x18,lVar3 + 0x2c,*(undefined *)(lVar3 + 0x28)),
         cVar5 == '\0')) {
        local_38 = 0x80fe;
        local_30 = 0x200000000000000;
        cVar5 = in6_equal_net(lVar2 + 0x18,&local_38,0x40);
        if (((cVar5 == '\0') ||
            (cVar5 = in6_equal_mach(lVar2 + 0x18,lVar3 + 0x2c,0x40), cVar5 == '\0')) &&
           ((cVar5 = in6_equal_net(lVar2 + 0x18,lVar3 + 0x18,*(undefined *)(lVar3 + 0x28)),
            cVar5 == '\0' ||
            (cVar5 = in6_equal_mach(lVar2 + 0x18,lVar3 + 0x44,*(undefined *)(lVar3 + 0x28)),
            cVar5 == '\0')))) {
          local_28 = 0x80fe;
          local_20 = 0x200000000000000;
          cVar5 = in6_equal_net(lVar2 + 0x18,&local_28,0x40);
          if ((cVar5 == '\0') ||
             (cVar5 = in6_equal_mach(lVar2 + 0x18,lVar3 + 0x44,0x40), cVar5 == '\0')) {
            g_log("Slirp",8,"external icmpv6 not supported yet");
            goto LAB_00112ea6;
          }
        }
      }
      icmp6_send_echoreply(param_1,lVar3,lVar2,pbVar4);
    }
    else if ((0x7f < bVar1) && (bVar1 - 0x85 < 5)) {
      ndp_input(param_1,lVar3,lVar2,pbVar4);
    }
  }
LAB_00112ea6:
  m_free(param_1);
...
void tcp_fasttimo(long param_1)
...
void tcp_slowtimo(long param_1)
      ...
      if (lVar2 != 0) {
        for (iVar3 = 0; iVar3 < 4; iVar3 = iVar3 + 1) {
          if (((*(short *)(lVar2 + 2 + ((long)iVar3 + 8) * 2) != 0) &&
             ...
             (tcp_timers(lVar2,iVar3), plVar4 != (long *)plVar1[1])) goto LAB_0011307b;
        }
...
void tcp_canceltimers(long param_1)
...
long tcp_timers(long param_1,int param_2)
  ...
  if (param_2 == 3) {
    ...
    if (param_2 == 2) {
      if (3 < *(short *)(param_1 + 0x10)) {
        if ((slirp_do_keepalive == '\0') || (5 < *(short *)(param_1 + 0x10))) {
          *(undefined2 *)(param_1 + 0x16) = 0x3840;
          return param_1;
        }
        if (*(short *)(param_1 + 0xb4) < 0x3cf0) {
          tcp_respond(param_1,param_1 + 0x28,0,*(undefined4 *)(param_1 + 0x98),
      ...
      if (param_2 == 0) {
          ...
          *(ushort *)(param_1 + 0x20) = *(ushort *)(param_1 + 0x20) >> 1;
          if (*(ushort *)(param_1 + 0x20) < 0x20) {
            *(undefined2 *)(param_1 + 0x1a) = 0xc;
            lVar3 = tcp_drop(param_1,(int)*(short *)(param_1 + 0xca));
            return lVar3;
          }
        ...
        *(undefined2 *)(param_1 + 0x1e) = 0;
        tcp_output(param_1,(ulong)uVar1,(ulong)(uVar2 >> 1) % (ulong)uVar1);
      }
      else if (param_2 == 1) {
        tcp_setpersist(param_1);
...
undefined8 sockaddr_equal(short *param_1,short *param_2)

{
  ...
  if (*param_1 == *param_2) {
    if (*param_1 == 2) {
      ...
      cVar1 = in6_equal(param_1 + 4,param_2 + 4);
...
undefined8 * solookup(long *param_1,undefined8 *param_2,undefined8 param_3,long param_4)

{
  ...
  puVar2 = (undefined8 *)*param_1;
  if (((puVar2 == param_2) || (iVar1 = sockaddr_equal(puVar2 + 0x19,param_3), iVar1 == 0)) ||
     ((param_4 != 0 && (iVar1 = sockaddr_equal(puVar2 + 9,param_4), iVar1 == 0)))) {
    for (local_10 = (undefined8 *)*param_2; local_10 != param_2; local_10 = (undefined8 *)*local_10)
    {
      iVar1 = sockaddr_equal(local_10 + 0x19,param_3);
      if ((iVar1 != 0) &&
         ((param_4 == 0 || (iVar1 = sockaddr_equal(local_10 + 9,param_4), iVar1 != 0)))) {
...
void * socreate(undefined8 param_1)
...
void soqfree(long param_1,undefined8 *param_2)
...
void sofree(long *param_1)

{
  long lVar1;
  
  lVar1 = param_1[5];
  soqfree(param_1,lVar1 + 0xc0);
  soqfree(param_1,lVar1 + 0xd0);
...
long sopreprbuf(long param_1,undefined8 *param_2,int *param_3)
...

{
  ...
  local_d8 = sopreprbuf(param_1,&local_c8,&local_fc);
  if (local_d8 == 0) {
                    // WARNING: Subroutine does not return
  ...
  if (local_f8[3] < 1) {
    if ((local_f8[3] < 0) &&
      ...
      sofcantrcvmore(param_1);
      if ((((local_f8[0] == 0x68) || (local_f8[0] == 0x6f)) || (local_f8[0] == 0x6b)) ||
         (local_f8[0] == 0x20)) {
        tcp_drop(*(undefined8 *)(param_1 + 0x150),local_f8[0]);
      }
      else {
        tcp_sockclosed(*(undefined8 *)(param_1 + 0x150));
      }
      iVar1 = -1;
    }
  }
...
int soreadbuf(long param_1,void *param_2,int param_3)

{
  ...
  uVar1 = sopreprbuf(param_1,&local_38,local_4c);
...

{
  ...
  if (*(ulong *)(param_1 + 0x178) < *(ulong *)(param_1 + 0x170)) {
    local_82c = slirp_send(param_1,*(undefined8 *)(param_1 + 0x178),*(undefined4 *)(param_1 + 0x40),
                           1);
  }
  else {
    ...
    local_82c = slirp_send(param_1,local_818,(long)(int)local_828,1);
  }
  if (-1 < (int)local_82c) {
...
LAB_00114858:
    ...
    local_50 = slirp_send(param_1,*(undefined8 *)(param_1 + 0x178),local_30,0);
    if ((local_50 < 0) &&
    ...
    if (0 < local_50) {
      if (((local_54 == 2) && ((long)local_50 == local_30)) &&
         (iVar4 = slirp_send(param_1,local_28,local_20,0), 0 < iVar4)) {
...

{
  ...
  if (*(char *)(param_1 + 0x14a) == '\x01') {
    ...
    if ((local_2b4 == -1) || (local_2b4 == 0)) {
      ...
      piVar5 = __errno_location();
      pcVar6 = strerror(*piVar5);
      icmp_send_error(*(undefined8 *)(param_1 + 0x30),3,local_2c2,0,pcVar6);
    }
    else {
      icmp_reflect(*(undefined8 *)(param_1 + 0x30));
    ...
    if (iVar3 == 0) {
      if ((local_2bc != 0) && (local_2b0 = m_get(*(undefined8 *)(param_1 + 0x28)), local_2b0 != 0))
      {
        if (*(short *)(param_1 + 0x48) == 2) {
        ...
        *(int *)(local_2b0 + 0x38) = (int)sVar4;
        ...
        if (*(int *)(local_2b0 + 0x38) < 0) {
          if (*(short *)(param_1 + 200) == 2) {
            ...
            piVar5 = __errno_location();
            pcVar6 = strerror(*piVar5);
            icmp_send_error(*(undefined8 *)(param_1 + 0x30),3,local_2c1,0,pcVar6);
          }
            ...
            icmp6_send_error(*(undefined8 *)(param_1 + 0x30),1,local_2c1);
          }
          else {
            g_assertion_message_expr
                      ("Slirp",
          ...
          if (*(int *)(param_1 + 0x158) != 0) {
            ...
            uVar2 = htons(0x35);
            if (uVar1 == uVar2) {
              *(int *)(param_1 + 0x158) = curtime + 10000;
            }
            else {
              *(int *)(param_1 + 0x158) = curtime + 240000;
            }
          ...
          local_1b8 = local_238;
          local_1b0 = local_230;
          sotranslate_in(param_1,&local_228);
          ...
          if (*(short *)(param_1 + 0x48) == 2) {
            udp_output(param_1,local_2b0,&local_228,&local_1a8,*(undefined *)(param_1 + 0x148));
          }
          else if (*(short *)(param_1 + 0x48) == 10) {
            udp6_output(param_1,local_2b0,&local_228,&local_1a8);
          }
          else {
            g_assertion_message_expr
                      ("Slirp",
...
undefined8 sosendto(long param_1,long param_2)

{
  ...
  iVar1 = sotranslate_out(param_1,&local_a8);
  if (iVar1 < 0) {
    uVar2 = 0xffffffff;
  }
  else {
    __addr_len = sockaddr_size(&local_a8);
...
long tcp_listen(long param_1,in_addr param_2,uint16_t param_3,in_addr param_4,uint16_t param_5,
               uint param_6)

{
  ...
  *(undefined8 *)(local_30 + 0x150) = uVar4;
  if (*(long *)(local_30 + 0x150) == 0) {
    ...
    slirp_insque(local_30,param_1 + 0x1c0);
    if ((param_6 & 0x200) != 0) {
    ...
    *(in_addr_t *)(local_30 + 0xcc) = param_4.s_addr;
    ...
    local_38 = slirp_socket(2,1,0);
    if (-1 < local_38) {
      iVar2 = slirp_socket_set_fast_reuse(local_38);
      if (-1 < iVar2) {
        ...
        if (-1 < iVar2) {
          ...
          if (-1 < iVar2) {
            ...
            *(undefined2 *)(local_30 + 0x4a) = local_28.sa_data._0_2_;
            if ((local_28.sa_data._2_4_ == 0) || (local_28.sa_data._2_4_ == loopback_addr)) {
...
void soisfconnecting(long param_1)
...
void soisfconnected(long param_1)
...
void sofcantrcvmore(long param_1)
...
void sofcantsendmore(long param_1)
...
undefined4 sotranslate_out4(long param_1,long param_2,long param_3)

{
  ...
  if ((*(char *)(param_1 + 0x1788) == '\x01') ||
    ...
    if ((*(int *)(param_2 + 0x4c) == *(int *)(param_1 + 0x14)) || (*(int *)(param_2 + 0x4c) == -1))
    {
      ...
      *(undefined4 *)(param_3 + 4) = loopback_addr;
    }
    uVar4 = 1;
  }
  else {
    ...
    uVar2 = htons(0x35);
    if ((uVar1 == uVar2) && (iVar3 = get_dns_addr(param_3 + 4), -1 < iVar3)) {
      uVar4 = 1;
    }
    else {
      uVar4 = 0;
...
undefined8 sotranslate_out6(long param_1,long param_2,long param_3)

{
  ...
  local_20 = *(long *)(in_FS_OFFSET + 0x28);
  if (*(char *)(param_1 + 0x1788) != '\x01') {
    cVar2 = in6_equal(param_2 + 0x50,param_1 + 0x44);
    if (cVar2 != '\0') {
      uVar1 = *(uint16_t *)(param_2 + 0x4a);
      uVar3 = htons(0x35);
      if (uVar1 == uVar3) {
        iVar4 = get_dns6_addr(param_3 + 8,&local_3c);
        if (-1 < iVar4) {
  ...
  cVar2 = in6_equal_net(param_2 + 0x50,param_1 + 0x18,*(undefined *)(param_1 + 0x28));
  if (cVar2 == '\0') {
    local_38 = 0x2ff;
    local_30 = 0x100000000000000;
    cVar2 = in6_equal(param_2 + 0x50,&local_38);
...
undefined8 sotranslate_out(long param_1,short *param_2)

{
  ...
  local_9 = '\x01';
  if (*param_2 == 2) {
    local_9 = sotranslate_out4(*(undefined8 *)(param_1 + 0x28),param_1,param_2);
  }
  else if (*param_2 == 10) {
    local_9 = sotranslate_out6(*(undefined8 *)(param_1 + 0x28),param_1,param_2);
  }
  if (local_9 == '\x01') {
    uVar2 = 0;
  }
...
void sotranslate_in(long param_1,short *param_2)

{
  ...
  if (*param_2 == 2) {
    if ((*(uint *)(param_1 + 0x4c) & *(uint *)(lVar1 + 0x10)) == *(uint *)(lVar1 + 0xc)) {
      if (~*(uint *)(lVar1 + 0x10) == (*(uint *)(param_1 + 0x4c) & ~*(uint *)(lVar1 + 0x10))) {
      ...
      else if ((*(int *)(param_2 + 2) == loopback_addr) ||
        ...
        *(undefined4 *)(param_2 + 2) = *(undefined4 *)(param_1 + 0x4c);
           ...
           (cVar3 = in6_equal_net(param_1 + 0x50,lVar1 + 0x18,*(undefined *)(lVar1 + 0x28)),
           cVar3 != '\0')) &&
          ((cVar3 = in6_equal(param_2 + 4,&in6addr_loopback), cVar3 != '\0' ||
           (cVar3 = in6_equal(param_1 + 0x50,lVar1 + 0x2c), cVar3 != '\x01')))) {
...
void sotranslate_accept(long param_1)

{
  ...
  if (*(short *)(param_1 + 0x48) == 2) {
    if ((*(int *)(param_1 + 0x4c) == 0) ||
       ((loopback_mask & (loopback_addr ^ *(uint *)(param_1 + 0x4c))) == 0)) {
      *(undefined4 *)(param_1 + 0x4c) = *(undefined4 *)(lVar1 + 0x14);
    }
  }
  else if ((*(short *)(param_1 + 0x48) == 10) &&
          ((cVar3 = in6_equal(param_1 + 0x50,in6addr_any), cVar3 != '\0' ||
           (cVar3 = in6_equal(param_1 + 0x50,&in6addr_loopback), cVar3 != '\0')))) {
...
void sodrop(long param_1,int param_2)

{
  char cVar1;
  
  cVar1 = sbdrop(param_1 + 0x188,(long)param_2);
  if (cVar1 != '\0') {
...
void ip_cleanup(undefined8 param_1)

{
  udp_cleanup(param_1);
  tcp_cleanup(param_1);
  icmp_cleanup(param_1);
  return;
}



void ip_input(long param_1)
    ...
    if ((0x13 < *(uint *)(param_1 + 0x38)) &&
      ...
      if ((0x13 < uVar5) &&
         (((int)uVar5 <= *(int *)(param_1 + 0x38) &&
          (iVar6 = cksum(param_1,(ulong)bVar3 << 2), iVar6 == 0)))) {
        ...
        if (uVar5 <= *(ushort *)(pbVar7 + 2)) {
          ...
          *(uint16_t *)(pbVar7 + 6) = uVar4;
          if ((int)(uint)*(ushort *)(pbVar7 + 2) <= *(int *)(param_1 + 0x38)) {
            if ((int)(uint)*(ushort *)(pbVar7 + 2) < *(int *)(param_1 + 0x38)) {
              m_adj(param_1,(uint)*(ushort *)(pbVar7 + 2) - *(int *)(param_1 + 0x38));
            }
            if (pbVar7[8] != 0) {
              local_40 = param_1;
...
LAB_001165ba:
                ...
                *(short *)(pbVar7 + 6) = *(short *)(pbVar7 + 6) << 3;
                if (((pbVar7[1] & 1) == 0) && (*(short *)(pbVar7 + 6) == 0)) {
                  if (puVar8 != (undefined8 *)0x0) {
                    ip_freef(lVar2,puVar8);
                  }
                }
                else {
                  pbVar7 = (byte *)ip_reass(lVar2,pbVar7,puVar8);
                  if (pbVar7 == (byte *)0x0) {
                    return;
                  }
                  local_40 = dtom(lVar2,pbVar7);
                }
              }
              bVar1 = pbVar7[9];
              if (bVar1 == 0x11) {
                udp_input(local_40,(ulong)bVar3 << 2);
                return;
              }
              if (bVar1 < 0x12) {
                if (bVar1 == 1) {
                  icmp_input(local_40,(ulong)bVar3 << 2);
                  return;
                }
                if (bVar1 == 6) {
                  tcp_input(local_40,(ulong)bVar3 << 2,0,2);
                  return;
                }
              }
              m_free(local_40);
            ...
            icmp_send_error(param_1,0xb,0,0,&DAT_0011e6c4);
          }
        }
      }
    }
...
byte * ip_reass(long param_1,byte *param_2,long *param_3)
...
LAB_00116c31:
    ...
    slirp_insque(plVar9 + 2,param_1 + 0xf8);
    ...
    if (plVar9 == local_60) {
      if ((*(byte *)(plVar9[1] + 0x11) & 1) == 0) {
        ...
        *(undefined4 *)(lVar5 + 0x20) = *(undefined4 *)(local_60 + 5);
        slirp_remque(local_60 + 2);
        uVar7 = dtom(param_1,local_60);
        m_free(uVar7);
...
void ip_freef(undefined8 param_1,undefined8 *param_2)

{
  ...
  while (puVar3 != param_2) {
    ...
    ip_deq(puVar3);
    uVar2 = dtom(param_1,puVar3);
    m_free(uVar2);
    puVar3 = puVar1;
  }
  slirp_remque(param_2 + 2);
  uVar2 = dtom(param_1,param_2);
  m_free(uVar2);
  return;
}
...
void ip_enq(long *param_1,long *param_2)
...
void ip_stripoptions(long param_1)
...
void ndp_table_add(long param_1,undefined8 param_2,undefined8 param_3,undefined *param_4)

{
  ...
  if ((char)local_88 != -1) {
    local_58 = 0;
    local_50 = 0;
    cVar1 = in6_equal(&local_88,&local_58);
    if (cVar1 == '\0') {
      for (local_64 = 0; local_64 < 0x10; local_64 = local_64 + 1) {
        cVar1 = in6_equal((long)local_64 * 0x18 + local_60 + 8,&local_88);
        if (cVar1 != '\0') {
          if ((slirp_debug & 1) != 0) {
...
undefined8 ndp_table_search(long param_1,undefined8 param_2,undefined8 param_3,undefined *param_4)
...
void icmp_cleanup(long param_1)
...
undefined8 icmp_send(long param_1,long param_2,int param_3)

{
  ...
  uVar2 = slirp_socket(2,2,1);
  *(undefined4 *)(param_1 + 0x10) = uVar2;
  if (*(int *)(param_1 + 0x10) == -1) {
    uVar4 = 0xffffffff;
  }
  else {
    iVar3 = slirp_bind_outbound(param_1,2);
    if (iVar3 == 0) {
      ...
      *(int *)(param_1 + 0x158) = curtime + 240000;
      ...
      slirp_insque(param_1,*(long *)(param_1 + 0x28) + 0x528);
      ...
      if (sVar5 == -1) {
        ...
        piVar6 = __errno_location();
        pcVar7 = strerror(*piVar6);
        icmp_send_error(param_2,3,0,0,pcVar7);
        icmp_detach(param_1);
      }
      uVar4 = 0;
    }
...
void icmp_input(long param_1,int param_2)
          ...
          if (bVar1 < 6) {
            ...
            *(short *)(lVar3 + 2) = *(short *)(lVar3 + 2) + (short)param_2;
            if ((*(int *)(lVar3 + 0x10) == *(int *)(lVar7 + 0x14)) ||
              ...
              icmp_reflect(param_1);
              goto LAB_00117ed4;
            }
            if (*(int *)(lVar7 + 0x7c) == 0) {
              lVar7 = socreate(lVar7);
              iVar6 = icmp_send(lVar7,param_1,param_2);
              if (iVar6 != 0) {
                iVar6 = udp_attach(lVar7,2);
                if (iVar6 == -1) {
                  if ((slirp_debug & 2) != 0) {
                  ...
                  *(undefined4 *)(lVar7 + 0x14c) = 4;
                  ...
                  iVar6 = sotranslate_out(lVar7,&local_a8);
                  if (iVar6 < 0) {
                    piVar8 = __errno_location();
                    pcVar9 = strerror(*piVar8);
                    icmp_send_error(param_1,3,0,0,pcVar9);
                    udp_detach(lVar7);
                  }
                  else {
                    __addr_len = sockaddr_size(&local_a8);
...
void icmp_send_error(long param_1,char param_2,char param_3,int param_4)

{
  ...
  if (((param_2 == '\x03') || (param_2 == '\v')) && (param_1 != 0)) {
    ...
    if ((slirp_debug & 2) != 0) {
      ...
      slirp_pstrcpy(local_68,0x14,pcVar8);
      pcVar8 = inet_ntoa((in_addr)*(in_addr_t *)(pbVar3 + 0x10));
      slirp_pstrcpy(local_48,0x14,pcVar8);
      if ((slirp_debug & 2) != 0) {
    ...
    if (((*(ushort *)(pbVar3 + 6) & 0x1fff) == 0) &&
      ...
      if (((pbVar3[9] != 1) ||
          ((pbVar3[(ulong)(bVar1 & 0xf) * 4] < 0x13 &&
           (*(int *)(icmp_flush + (long)(int)(uint)pbVar3[(ulong)(bVar1 & 0xf) * 4] * 4) == 0)))) &&
         (lVar9 = m_get(*(undefined8 *)(param_1 + 0x40)), lVar9 != 0)) {
        ...
        *(uint16_t *)(pcVar8 + 0xe) = uVar4;
        pcVar8[2] = '\0';
        pcVar8[3] = '\0';
        uVar5 = cksum(lVar9,*(undefined4 *)(lVar9 + 0x38));
...
void icmp_reflect(long param_1)

{
  ...
  *puVar3 = 0;
  *(undefined2 *)(puVar3 + 2) = 0;
  uVar5 = cksum(param_1,(uint)*(ushort *)(pbVar2 + 2) + uVar4 * -4);
  *(undefined2 *)(puVar3 + 2) = uVar5;
  *(long *)(param_1 + 0x30) = *(long *)(param_1 + 0x30) - (long)iVar6;
...
void icmp_receive(long param_1)

{
  ...
  *(int *)(lVar2 + 0x38) = *(int *)(lVar2 + 0x38) + iVar4;
  if (((int)sVar5 == -1) || ((int)sVar5 == 0)) {
    ...
    piVar6 = __errno_location();
    pcVar7 = strerror(*piVar6);
    icmp_send_error(*(undefined8 *)(param_1 + 0x30),3,iVar4 != 0x65,0,pcVar7);
  }
  else {
    icmp_reflect(*(undefined8 *)(param_1 + 0x30));
    *(undefined8 *)(param_1 + 0x30) = 0;
...
undefined2 * get_new_addr(long param_1,int *param_2,void *param_3)
...
short * request_addr(long param_1,uint32_t *param_2,void *param_3)
...
undefined2 * find_addr(long param_1,int *param_2,void *param_3)
...
void dhcp_decode(long param_1,uint *param_2,uint32_t *param_3)

{
  ...
  *param_3 = uVar3;
  ...
  iVar4 = memcmp((void *)(param_1 + 0x108),&rfc1533_cookie,4);
  if (iVar4 == 0) {
...
void bootp_reply(long param_1,long param_2)

{
  ...
  local_20 = *(long *)(in_FS_OFFSET + 0x28);
  local_70 = 0;
  dhcp_decode(param_2,&local_78,&local_7c);
  if ((slirp_debug & 1) != 0) {
  ...
  *(long *)(local_60 + 0x30) = *(long *)(local_60 + 0x30) + 0x1c;
  ...
  if (local_78 == 1) {
    uVar3 = htonl(0);
    if ((uVar4 != uVar3) && (local_70 = request_addr(param_1,&local_7c,&local_26), local_70 != 0)) {
      local_34[0] = local_7c;
    }
    if (local_70 == 0) {
LAB_00118c3e:
      local_70 = get_new_addr(param_1,local_34,&local_26);
      if (local_70 == 0) {
        if ((slirp_debug & 1) != 0) {
    ...
    *(undefined2 *)(local_70 + 6) = local_22;
    ...
    uVar3 = htonl(0);
    if (uVar4 == uVar3) {
      local_70 = find_addr(param_1,local_34,param_2 + 0x38);
      if (local_70 == 0) goto LAB_00118c3e;
    }
    else {
      local_70 = request_addr(param_1,&local_7c,&local_26);
      if (local_70 == 0) {
  ...
  arp_table_add(param_1,local_34[0],&local_26);
  ...
  *(undefined4 *)(local_60 + 0x38) = 0x224;
  udp_output(0,local_60,local_48,local_38,0x10);
LAB_001193fe:
  if (local_20 == *(long *)(in_FS_OFFSET + 0x28)) {
    return;
  }
...
void bootp_input(long param_1)

{
  if (*(char *)(*(long *)(param_1 + 0x30) + 0x1c) == '\x01') {
    bootp_reply(*(undefined8 *)(param_1 + 0x40),*(long *)(param_1 + 0x30));
  }
  return;
}
...
void ip6_init(undefined8 param_1)
...
void ip6_cleanup(undefined8 param_1)

{
  icmp6_cleanup(param_1);
  return;
}



void ip6_input(long param_1)
...
int ip_output(undefined8 param_1,long param_2)
    ...
    if (((*(ushort *)(pbVar2 + 6) & 0x4000) == 0) &&
      ...
      for (local_48 = uVar7 + 0x14; local_48 < (int)(uint)*(ushort *)(pbVar2 + 2);
        ...
        *(uint16_t *)((long)puVar3 + 2) = uVar5;
        iVar8 = m_copy(lVar9,param_2,local_48,local_4c);
        if (iVar8 < 0) {
          local_44 = -1;
          local_70 = param_2;
          goto LAB_00119ab5;
        ...
        *(undefined2 *)((long)puVar3 + 10) = 0;
        uVar6 = cksum(lVar9,0x14);
        *(undefined2 *)((long)puVar3 + 10) = uVar6;
        *local_38 = lVar9;
        local_38 = (long *)(lVar9 + 0x10);
      }
      m_adj(param_2,(uVar7 + 0x14) - (uint)*(ushort *)(pbVar2 + 2));
...
bool tftp_session_in_use(long *param_1)
...
void tftp_session_update(long param_1)

{
  *(undefined4 *)(param_1 + 0xa0) = curtime;
  return;
}



void tftp_session_terminate(undefined8 *param_1)
...
int tftp_session_allocate(long param_1,void *param_2,undefined2 *param_3)

{
  ...
  while( true ) {
    ...
    iVar1 = tftp_session_in_use(__s);
    if (iVar1 == 0) break;
    if (5000 < curtime - *(int *)(__s + 0x14)) {
      tftp_session_terminate(__s);
      break;
    }
    local_14 = local_14 + 1;
  }
  memset(__s,0,0xa8);
  uVar2 = sockaddr_size(param_2);
  memcpy(__s + 3,param_2,(ulong)uVar2);
  *(undefined4 *)(__s + 2) = 0xffffffff;
  *(undefined2 *)((long)__s + 0x14) = 0x200;
  *(undefined2 *)(__s + 0x13) = *param_3;
  *__s = param_1;
  tftp_session_update(__s);
  return local_14;
}



int tftp_session_find(long param_1,undefined8 param_2,short *param_3)

{
  ...
  while( true ) {
    ...
    iVar1 = tftp_session_in_use(lVar2);
    if (((iVar1 != 0) && (iVar1 = sockaddr_equal(lVar2 + 0x18,param_2), iVar1 != 0)) &&
...
undefined4 tftp_read_data(long param_1,int param_2,void *param_3,int param_4)
...
undefined8 tftp_prep_mbuf_data(long param_1,long param_2)
...
void tftp_udp_output(long *param_1,undefined8 param_2,long param_3)

{
  ...
  if (*(short *)(param_1 + 3) == 10) {
    ...
    udp6_output(0,param_2,local_58,local_38);
  }
  else {
    ...
    local_36 = *(undefined2 *)(param_1 + 0x13);
    udp_output(0,param_2,local_58,local_38,0x10);
  }
  if (local_10 != *(long *)(in_FS_OFFSET + 0x28)) {
                    // WARNING: Subroutine does not return
    __stack_chk_fail();
...
undefined8
tftp_send_oack(undefined8 *param_1,long param_2,long param_3,int param_4,undefined8 param_5)

{
  ...
  if (lVar3 == 0) {
    ...
    lVar5 = tftp_prep_mbuf_data(param_1,lVar3);
    uVar1 = htons(6);
    *(uint16_t *)(lVar5 + 8) = uVar1;
    for (local_20 = 0; local_20 < param_4; local_20 = local_20 + 1) {
      iVar2 = slirp_fmt0(lVar5 + 10 + (long)local_1c,0x596 - (long)local_1c,&DAT_0011eeda,
                         *(undefined8 *)(param_2 + (long)local_20 * 8));
      local_1c = local_1c + iVar2;
      iVar2 = slirp_fmt0(lVar5 + 10 + (long)local_1c,0x596 - (long)local_1c,&DAT_0011eedd,
                         *(undefined4 *)(param_3 + (long)local_20 * 4));
      local_1c = local_1c + iVar2;
    }
    *(int *)(lVar3 + 0x38) = local_1c + 2;
    tftp_udp_output(param_1,lVar3,param_5);
    uVar4 = 0;
  }
  return uVar4;
}
...
void tftp_send_error(undefined8 *param_1,uint16_t param_2,char *param_3,undefined8 param_4)

{
  ...
  lVar2 = m_get(*param_1);
  if (lVar2 != 0) {
    lVar3 = tftp_prep_mbuf_data(param_1,lVar2);
    uVar1 = htons(5);
    *(uint16_t *)(lVar3 + 8) = uVar1;
    uVar1 = htons(param_2);
    *(uint16_t *)(lVar3 + 10) = uVar1;
    slirp_pstrcpy(lVar3 + 0xc,0x594,param_3);
    sVar4 = strlen(param_3);
    *(int *)(lVar2 + 0x38) = (int)sVar4 + 5;
    tftp_udp_output(param_1,lVar2,param_4);
  }
  tftp_session_terminate(param_1);
  return;
}



void tftp_send_next_block(undefined8 *param_1,undefined8 param_2)

{
  ...
  lVar3 = m_get(*param_1);
  if (lVar3 != 0) {
    lVar4 = tftp_prep_mbuf_data(param_1,lVar3);
    uVar1 = htons(3);
    *(uint16_t *)(lVar4 + 8) = uVar1;
    uVar1 = htons((short)*(undefined4 *)((long)param_1 + 0x9c) + 1);
    *(uint16_t *)(lVar4 + 10) = uVar1;
    uVar2 = tftp_read_data(param_1,*(undefined4 *)((long)param_1 + 0x9c),lVar4 + 0xc,
                           *(undefined2 *)((long)param_1 + 0x14));
    if ((int)uVar2 < 0) {
      m_free(lVar3);
      tftp_send_error(param_1,1,"File not found",lVar4);
    }
    else {
      *(uint *)(lVar3 + 0x38) = uVar2 + 4;
      tftp_udp_output(param_1,lVar3,param_2);
      if (uVar2 == *(ushort *)((long)param_1 + 0x14)) {
        tftp_session_update(param_1);
      }
      else {
        tftp_session_terminate(param_1);
      }
...
void tftp_handle_rrq(long param_1,undefined8 param_2,long param_3,int param_4)

{
  ...
  local_10 = *(long *)(in_FS_OFFSET + 0x28);
  local_f8 = 0;
  iVar1 = tftp_session_find(param_1,param_2,param_3);
  if (-1 < iVar1) {
    tftp_session_terminate(param_1 + (long)iVar1 * 0xa8 + 0x6e0);
  }
  iVar1 = tftp_session_allocate(param_1,param_2,param_3);
  if (-1 < iVar1) {
    lVar4 = param_1 + (long)iVar1 * 0xa8 + 0x6e0;
    if (*(long *)(param_1 + 0x6d8) == 0) {
      tftp_send_error(lVar4,2,"Access violation",param_3);
    }
    else {
      local_fc = 0;
      iVar2 = param_4 + -10;
      ...
      if (iVar2 - iVar1 < 6) {
        ...
        if (iVar1 == 0) {
          ...
          if ((pcVar8 == (char *)0x0) && (sVar5 = strlen(pcVar7), pcVar7[sVar5 - 1] != '/')) {
            iVar1 = tftp_read_data(lVar4,0,0,0);
            if (iVar1 < 0) {
              tftp_send_error(lVar4,1,"File not found",param_3);
            }
              ...
              while ((local_fc < iVar2 && (local_f8 < 2))) {
                ...
                if (iVar1 == 0) {
                  ...
                  if (local_f4 == 0) {
                    iVar1 = stat(*(char **)(lVar4 + 8),&local_a8);
                    if (iVar1 != 0) {
                      tftp_send_error(lVar4,1,"File not found",param_3);
                      goto LAB_0011abed;
                    }
                    local_f4 = (uint)local_a8.st_size;
                  }
              ...
              if ((int)local_f8 < 1) {
                *(undefined4 *)(lVar4 + 0x9c) = 0;
                tftp_send_next_block(lVar4,param_3);
              }
              else {
                if (2 < local_f8) {
                    // WARNING: Subroutine does not return
                ...
                tftp_send_oack(lVar4,local_b8,local_c0,local_f8,param_3);
              }
            }
            else {
              tftp_send_error(lVar4,2,"Access violation",param_3);
          ...
          tftp_send_error(lVar4,4,"Unsupported transfer mode",param_3);
        }
      }
    }
  }
...
void tftp_handle_ack(long param_1,undefined8 param_2,undefined8 param_3)

{
  ...
  iVar1 = tftp_session_find(param_1,param_2,param_3);
  if (-1 < iVar1) {
    tftp_send_next_block((long)iVar1 * 0xa8 + 0x6e0 + param_1,param_3);
  }
  return;
}
...
void tftp_handle_error(long param_1,undefined8 param_2,undefined8 param_3)
...
void tftp_input(undefined8 param_1,long param_2)

{
  ...
  if (uVar2 == 5) {
    tftp_handle_error(*(undefined8 *)(param_2 + 0x40),param_1,lVar1,*(undefined4 *)(param_2 + 0x38))
    ;
  }
  else if (uVar2 < 6) {
    if (uVar2 == 1) {
      tftp_handle_rrq(*(undefined8 *)(param_2 + 0x40),param_1,lVar1,*(undefined4 *)(param_2 + 0x38))
      ;
    }
    else if (uVar2 == 4) {
      tftp_handle_ack(*(undefined8 *)(param_2 + 0x40),param_1,lVar1,*(undefined4 *)(param_2 + 0x38))
      ;
    }
  }
  return;
  ...
  if (*(int *)(lVar1 + 0x7c) == 0) {
    ...
    *(long *)(param_1 + 0x30) = *(long *)(param_1 + 0x30) + -0x28;
    ...
    if (iVar8 == 0) {
      ...
      if (uVar6 == 0x223) {
        cVar5 = in6_equal(puVar2 + 3,lVar1 + 0x2c);
        if (cVar5 == '\0') {
          local_78 = 0xff;
          local_77 = 2;
          local_76 = 0;
          ...
          local_6a = 0;
          local_69 = 2;
          cVar5 = in6_equal(puVar2 + 3,&local_78);
          if (cVar5 == '\0') goto LAB_0011b155;
        }
        *(long *)(param_1 + 0x30) = *(long *)(param_1 + 0x30) + 0x28;
        *(int *)(param_1 + 0x38) = *(int *)(param_1 + 0x38) + -0x28;
        dhcpv6_input(&local_68,param_1);
        *(long *)(param_1 + 0x30) = *(long *)(param_1 + 0x30) + -0x28;
        *(int *)(param_1 + 0x38) = *(int *)(param_1 + 0x38) + 0x28;
      }
      else {
LAB_0011b155:
        ...
        if ((uVar6 == 0x45) && (iVar8 = memcmp(puVar2 + 3,(void *)(lVar1 + 0x2c),0x10), iVar8 == 0))
        {
          *(long *)(param_1 + 0x30) = *(long *)(param_1 + 0x30) + 0x28;
          *(int *)(param_1 + 0x38) = *(int *)(param_1 + 0x38) + -0x28;
          tftp_input(&local_68,param_1);
          *(long *)(param_1 + 0x30) = *(long *)(param_1 + 0x30) + -0x28;
          *(int *)(param_1 + 0x38) = *(int *)(param_1 + 0x38) + 0x28;
        }
        else {
          local_98 = solookup(lVar1 + 0x520,lVar1 + 0x378,&local_68,0);
          if (local_98 == 0) {
            local_98 = socreate(lVar1);
            iVar8 = udp_attach(local_98,10);
            if (iVar8 == -1) {
              if ((slirp_debug & 2) != 0) {
          ...
          *(long *)(param_1 + 0x30) = *(long *)(param_1 + 0x30) + 0x30;
          iVar8 = sosendto(local_98,param_1);
          if (iVar8 != -1) {
            m_free(*(undefined8 *)(local_98 + 0x30));
            *(int *)(param_1 + 0x38) = *(int *)(param_1 + 0x38) + 0x30;
            *(long *)(param_1 + 0x30) = *(long *)(param_1 + 0x30) + -0x30;
            *puVar2 = local_48;
            puVar2[1] = local_40;
...
void udp6_output(undefined8 param_1,long param_2,long param_3,long param_4)

{
  ...
  *puVar1 = *(undefined2 *)(param_3 + 2);
  ...
  puVar1[3] = 0;
  uVar5 = ip6_cksum(param_2);
  puVar1[3] = uVar5;
  if (puVar1[3] == 0) {
    puVar1[3] = 0xffff;
  }
  ip6_output(param_1,param_2,0);
  return;
}



undefined8 dhcpv6_parse_info_request(long param_1,undefined *param_2,int param_3,long *param_4)
...
void dhcpv6_info_request(long param_1,long param_2,undefined4 param_3,undefined8 param_4,
                        undefined4 param_5)

{
  ...
  local_98 = (void *)0x0;
  local_90 = 0;
  iVar3 = dhcpv6_parse_info_request(param_1,param_4,param_5,&local_98);
  if ((-1 < iVar3) && (lVar4 = m_get(param_1), lVar4 != 0)) {
    ...
    *(int *)(lVar4 + 0x38) = (int)local_b0 - (int)*(undefined8 *)(lVar4 + 0x30);
    udp6_output(0,lVar4,local_88,local_68);
  }
  if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
    return;
  }
...
void dhcpv6_input(undefined8 param_1,long param_2)

{
  ...
  if (3 < iVar1 + -8) {
    uVar3 = ntohl(*puVar4);
    if (*(char *)puVar4 == '\v') {
      dhcpv6_info_request(*(undefined8 *)(param_2 + 0x40),param_1,uVar3 & 0xffffff,lVar2 + 0xc,
                          iVar1 + -0xc);
    }
    else if ((slirp_debug & 2) != 0) {
